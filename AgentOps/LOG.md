done: ui-polish — CAD interface polish (2026-05-12) — new sweep/loft/measure/section SVG icons; fixed Sweep+Loft toolbar icon duplicates; replaced Unicode Measure/Section text with SVGs; CornerRadius on toolbar buttons, toggle buttons, constraint buttons, SketchTaskCard, SketchSidePanel; FeatureDialogButtonPrimary is now solid filled blue; hover states added; LetterSpacing on ToolbarGroupLabel; commit 55971de
