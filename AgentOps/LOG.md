done: Fix Point/Line/Rectangle sketch rendering (2026-05-10) — Point size: Three.js 4/6→16/18px, software 3.2/3.8→6.0/7.0px; Line preview: cursor point before first click; Rectangle preview: cursor point before anchor; Point tool: preview cursor added in BuildPreviewEntities switch; branch: claude/youthful-hawking-U7VHz
