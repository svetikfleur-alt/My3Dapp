done: UI-POLISH — CAD interface polish (2026-05-15) — 4 new SVG icons (sweep/loft/measure/section-view); toolbar icon deduplication (Sweep/Loft were reusing Extrude/Revolve icons); Measure+SectionView replaced unicode glyphs; SketchTaskCard/SketchSidePanel/SketchConstraintToolButton got CornerRadius; FeatureDialogButton pointerover+pressed states; Dark theme link-button hover + AssistantKeyInput focus; both themes updated; commit 6d7b468
