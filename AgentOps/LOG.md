done: 66 — Sketch solver + definition behavior (2026-05-11) — Tangent case added to ApplyConstraintToGeometry (re-asserts line-arc and arc-arc tangency each solver pass); solver iterations 4→8; committed-sketch param edit now merges constraints/dimensions instead of replacing (preserves manual constraints); Engine/CadProjectStore.cs only; commit 1287468
