inspector-fix: 2026-05-16 — M key move tool now guarded to 3D mode only (was activating gizmo in sketch mode); Hole dialog default changed from "Blind" to "ThroughAll"; VERIFICATION.md written; 3 architectural issues reported to Builder
...
v1-foundation: 2026-05-16 — added StudioDocumentUiState persistence through StudioWorkspaceController, autosave callback + recovery status in shell, Save As `.umxproj` flow, unsaved/save/autosave labels, template parameter commit-on-edit, template command preview, and new SimpleBox/Lid manifests; build 0 errors 0 warnings
