verified: 2026-05-11 — Inspector pass (claude/inspiring-fermi-WKlvN) — Sketch preview cursor dots restored (Point/Line/Rectangle tools); tree icon/glyph overlap flagged; Sweep/Loft icon reuse flagged; Builder tasks A-E created; full report in VERIFICATION.md
done: 67 — Shell consistency pass (2026-05-10) — Toolbar ToolSplitGroup uniformity: View/Transform/Modify/Boolean/Datum (3D) and Transform/Dimension/Constraints (sketch) groups now use consistent ToolSplitGroup containers; Boolean group uses single IsVisible wrapper; commit bf3ba82
