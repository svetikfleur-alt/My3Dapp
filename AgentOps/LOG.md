verified: 2026-05-15 — Inspector pass; 1 local bug fixed (SectionAxisCombo missing SelectionChanged handler); 4 Builder tasks logged (Sweep/Loft icons, spline profile rejection, feature tree grouping, constraint selection model); static analysis only — no dotnet in cloud env
