done: 65 — CAD command dialog standardization (2026-05-13) — BooleanBodyDialog: FeatureDialogSectionCard/FieldLabel/Input/CheckBox classes applied, FEATURE badge added, ShowInTaskbar=False, OK→Apply; Recipe debug rows removed from Extrude/Revolve/Sweep/Loft/Mirror AXAML; RecipeTextBlock named refs and BuildRecipeText helpers removed from code-behind; dialog heights trimmed; commit e50aad2; 0 errors expected
