inspection: 2026-05-12 — routine-inspector — fixed: SketchRotateToolButton missing IsChecked binding + IsRotateSketchToolSelected property; datum plane store handlers (Create/Toggle/Delete) were absent causing silent Failure; commit a3a3685
